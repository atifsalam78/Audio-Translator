...
#Input destination language from the user, Mapping user input with the language code
def destination_language():
	...
	# wants to translate
	to_lang = input("Enter the language in which you want to convert \# : Ex. Hindi , English , etc.")
	# while (to_lang == "None"):
	# 	to_lang = takecommand()
